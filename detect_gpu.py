# detect_gpu.py — AMD GPU architecture detection for Windows ROCm installers.
#
# Copied verbatim from comfyui-rocm (https://github.com/patientx/comfyui-rocm).
# Copyright (C) the comfyui-rocm authors (patientx and contributors).
#
